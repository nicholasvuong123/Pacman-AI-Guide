...
def depthFirstSearch(problem):
    ...
    # This is Pacman's starting state
    ...
    # Add starting node and command for Pacman to follow into stack
    stack.push((startingNode, []))

    # While the board is not empty
    while not stack.isEmpty():

        # The node and action that is popped from the stack will be assigned 
        ...
        if currentNode not in explored:
            ...
            # check the next node and push the next node and action to get to it into the stack
...
def aStarSearch(problem, heuristic=nullHeuristic):
    ...
    while not queue.isEmpty():
        ...
        # The node, action, and cost that is popped from the queue will be assigned 
        # to the variables currentNode, actions, and currentCost, respectively
        ...
        if currentNode not in explored:
            ...
            for nextNode, action, cost in problem.getSuccessors(currentNode):
                ...
                # Get priority based on heuristic h(n)
